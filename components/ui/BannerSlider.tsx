  ...
  return (
    <div className="relative pt-24 md:pt-32 pb-8 md:pb-12 px-4 md:px-8 min-h-[90vh] md:min-h-screen w-full bg-paper flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto w-full flex flex-col lg:flex-row gap-4 md:gap-6 relative z-10 flex-grow lg:h-[80vh]">
        ...
        {/* LEFT: Info Card */}
        <div className="w-full lg:w-[40%] bg-glass backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] p-6 md:p-12 lg:p-16 shadow-2xl shadow-blue-900/5 border border-white/60 relative overflow-hidden z-20 flex flex-col justify-center min-h-[400px]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full px-3 py-1 md:px-4 md:py-1.5 mb-6 md:mb-8 w-fit border border-blue-100">
                 ...
                 <div className="flex items-center gap-2 px-2 md:px-4">
                    {slides.map((_, i) => (
                      <button 
                        ...
                        className={`w-2 h-2 md:w-3 md:h-3 rounded-full transition-all duration-300 ${current === i ? 'bg-cobalt scale-125 ring-2 md:ring-4 ring-blue-100' : 'bg-slate-300 hover:bg-slate-400'}`}
                      />
                    ))}
                 </div>
              </div>
