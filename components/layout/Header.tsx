  ...
  return (
    <>
      <header className={cn(
        ...
        <div className={cn(
          "relative flex items-center justify-between transition-all duration-500 border border-white/40 shadow-xl shadow-indigo-900/5 backdrop-blur-2xl",
          scrolled 
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="h-8 w-8 md:h-10 md:w-10 bg-gradient-to-br from-cobalt to-indigo-900 rounded-lg md:rounded-xl flex items-center justify-center text-white shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform rotate-0 group-hover:rotate-180 duration-500">
