  ...
  <Link href={`/products/${item.id}`}>
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
        <p className="text-cobalt-300 text-xs font-mono font-bold mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
          {item.spec}
        </p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
                  <div>
                    <h3 className="text-3xl font-display font-bold">
                      {activeTab === "drainage" ? "Drainage Collection" : "Fabrication Capabilities"}
                    </h3>
            ...
            <div className="flex flex-col md:flex-row gap-16">
              ...
              <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-6 rounded-3xl bg-tech-50 border border-tech-100 hover:border-cobalt/30 transition-colors bg-white/50 backdrop-blur-sm"
                  >
